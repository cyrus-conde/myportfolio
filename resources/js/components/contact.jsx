...
const Contact = () => {
  ...
  captchaRef.current.reset();*/}
    ...
    emailjs.send('service_karvu3n', 'template_mto7otp', content, '_nE3NA6HJqPdgtBre')
      .then((result) => { 
      ...
      <div className="lg:w-1/2 md:w-2/3 mx-auto">
        ...
        <div className="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
          ...
          <span className="inline-flex gap-2">
            <a href="https://www.facebook.com/hrtcyrs" target="_blank"><FaFacebook/></a>
...
if (document.getElementById('contact')) {
    const Contacts = ReactDOM.createRoot(document.getElementById("contact"));
